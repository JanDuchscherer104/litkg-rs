...
| Ollama | Optional local model backend | [Ollama](https://ollama.com/) | [`scripts/kg/ingest_docs.sh`](../scripts/kg/ingest_docs.sh), [`scripts/kg/enrich_embeddings.py`](../scripts/kg/enrich_embeddings.py), [`scripts/benchmarks/run_repo_qa.py`](../scripts/benchmarks/run_repo_qa.py) | Provides local OpenAI-compatible chat/embedding calls for Graphiti doc ingestion, embedding enrichment, and optional benchmark answering. |
